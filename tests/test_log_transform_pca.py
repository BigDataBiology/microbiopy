...
def test_log_transform_pca():
  ...
  matrix = np.array([[1, 1], [2, 1], [3, 2], [1, 1], [2, 1], [3, 2]], dtype=np.float32)
  lt_test = np.array([[ 0.04879012,  0.04879012], [ 0.71783978,  0.04879012],
      [ 1.11514163,  0.71783978], [ 0.04879012,  0.04879012],
      [ 0.71783978,  0.04879012], [ 1.11514163,  0.71783978]], dtype=np.float32)
  ...
  assert np.allclose(ltp.do_pca(lt_test), pca_test)
